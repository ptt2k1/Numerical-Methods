...
#input, output
#region
inputPath_5 = "input6.txt"

outputPath_5 = "output6.txt"
def ReadInput(file):
    f = file.readline()
...
result = Pica(filename, M = 10, L = 3)                     # loại 1
result1 = Pica(filename, M = 10, L =3, length = 31)       # loại 2
