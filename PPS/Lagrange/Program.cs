    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (System.IO.File.Exists(fileInput))
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    chia = hoocnerChia(daThucNoiSuy2, n, x[i]);
                    sWrite.WriteLine("\n\nTai x = {0}", x[i]);
                ...
                sWrite.WriteLine("\n\nTai x = {0}", 0.15);
                sWrite.WriteLine("Gia tri P(x) = {0}", hoocnerChia(daThucNoiSuy2, n, 0.15)[n - 1]);
